  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        {/* Hero content */}
        <div className="relative pt-60 pb-8 md:pt-60 md:mt-60 md:pb-20">
          ...
          <ModalVideo
            ...
            videoWidth={1920}
            videoHeight={1080} /> */}
          <div className="relative pt-2 pb-2 md:pt-60 md:pb-2">

            {/* Section header */}
            <div className="max-w-3xl mx-auto text-center pb-6 md:pb-6">
              <h1 className="h1 mb-4" data-aos="fade-up">Questions</h1>
              <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever.</p>
          ...
          <div className="min-h-screen flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-12">
              {/* Card 1 */}
              <div className="relative p-4 rounded-lg shadow-lg hover:shadow-xl">
                <div className="bg-gradient-to-b from-violet-500 via-purple-900 to-purple-600 rounded-lg absolute inset-0 filter blur-lg opacity-50"></div>
                <div className="light-effect"></div>
                <h2 className="text-2xl font-semibold text-white-300 mb-2 relative z-10">Pregunta 1</h2>
                <p className="text-gray-400 mb-4 relative z-10">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac turpis nec dolor consectetur.
                </p>
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-md text-center text-white hover:shadow-md relative z-10">
                  Respuesta aquí
                </div>
              </div>
              ...
              <div className="relative p-4 rounded-lg shadow-lg hover:shadow-xl">
                <div className="bg-gradient-to-b from-violet-500 via-purple-900 to-purple-600 rounded-lg absolute inset-0 filter blur-lg opacity-50"></div>
                <div className="light-effect"></div>
                <h2 className="text-2xl font-semibold text-purple-300 mb-2 relative z-10">Pregunta 2</h2>
                <p className="text-gray-400 mb-4 relative z-10">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac turpis nec dolor consectetur.
                </p>
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-md text-center text-white hover:shadow-md relative z-10">
              ...
              <div className="relative p-4 rounded-lg shadow-lg hover:shadow-xl">
                <div className="bg-gradient-to-b from-violet-500 via-purple-900 to-purple-600 rounded-lg absolute inset-0 filter blur-lg opacity-50"></div>
                <div className="light-effect"></div>
                <h2 className="text-2xl font-semibold text-white-300 mb-2 relative z-10">Pregunta 3</h2>
                <p className="text-white-400 mb-4 relative z-10">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac turpis nec dolor consectetur.
                </p>
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-md text-center text-white hover:shadow-md relative z-10">
                  Respuesta aquí
